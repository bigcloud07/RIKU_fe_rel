...
const NewFlashRunList: React.FC = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center w-full max-w-[430px] mx-auto">
            {/* 상단바 */}
            ...
            {/* 오늘의 러닝 */}
            <div className="relative bg-kuDarkGreen w-full max-w-[430px min-h-[268px]">
    ...
    [&>.swiper-pagination-bullet]:mx-[4px]"
                        ...
                        <div className="flex flex-col items-center justify-center w-[335px] h-[200px] bg-kuLightGray rounded-lg mt-4">
                            <p className="text-[18px] font-semibold text-black">현재 진행중인 정규런이 없습니다.</p>
            ...
            {/* 구분선 */}
            <div className="w-full max-w-[430px] h-[8px] bg-kuLightGray mt-[32px]"></div>
