  ...
  return (
    <div className="flex flex-col items-center min-h-screen">
      ...
      <div className="w-full max-w-md px-4">
        ...
        <DateNtime onDateTimeChange={(date, time) => setDateTime({ date, time })} />

        <div className="mb-2 mt-4">세부사항</div>
        <textarea className="my-2 w-full p-2 border rounded-lg" rows={10} placeholder="세부사항을 입력하세요" value={content} onChange={(e) => setContent(e.target.value)} />
