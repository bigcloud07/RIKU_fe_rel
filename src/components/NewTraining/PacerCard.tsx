    ...
    return (
        <div className="w-[335px] rounded-xl overflow-hidden">
            ...
            <div className="grid grid-cols-[60px_1.5fr_1fr_1fr] gap-x-2 gap-y-2 text-white text-center text-sm font-semibold">
                ...
                <div className="p-3 rounded-[10px] bg-[#FFC002]">페이서</div>
                <div className="p-3 rounded-[10px] bg-[#FFC002]">거리</div>
                <div className="p-3 rounded-[10px] bg-[#FFC002]">페이스</div>
            </div>
                ...
                >
                    ...
                    <div
                        className={`p-3 font-semibold rounded-[10px] text-white mt-1 ${idx === 0
                                ? 'bg-[#FFC002] bg-opacity-100'
                                : idx === 1
                                    ? 'bg-[#FFC002] bg-opacity-75'
                                    : idx === 2
                                        ? 'bg-[#FFC002] bg-opacity-50'
                                        : idx === 3
                                            ? 'bg-[#FFC002] bg-opacity-30'
                                            : idx === 4
                                                ? 'bg-[#FFC002] bg-opacity-10'
                                                : 'bg-[#FFC002] bg-opacity-5' // 기본값
                            } rounded-l-xl`}
                    >
                        {pacer.group}
                    </div>
