      ...
      <div className="flex">
        ...
        <div className="flex flex-1 text-black text-sm font-semibold text-center ml-[4px]">
          ...
          <div className="relative w-[79px] bg-[#FFC002] h-[52px] flex text-[16px] items-center justify-center font-bold">
            거리
            <div className="absolute top-[20%] right-0 w-[1px] h-[60%] bg-white opacity-60 translate-x-1/2" />
          </div>
          <div className="w-[77px] bg-[#FFC002] h-[52px] flex items-center text-[16px] justify-center rounded-tr-[10px] rounded-br-[10px] font-bold">
            페이스
          </div>
        </div>
      </div>
              ...
              : idx === 2 ? 'bg-opacity-50'
                ...
                return (
                    <div key={idx} className="flex gap-x-[4px] items-center">
                      {/* 그룹 셀 - 왼쪽에 단독 박스로 분리 */}
                      <div className={`w-[52px] h-[52px] flex items-center justify-center text-[#00000099] font-bold bg-[#FFC002] ${opacity} rounded-[10px]`}>
                        {pacer.group}
                      </div>
