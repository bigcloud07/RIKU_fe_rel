...
const PastRuns:React.FC<PastRunsProps> = ({date, peoplecount, title, postimg}) => {
    return(
        <div className="relative w-[103.05px] h-[152px] bg-kuLightGray rounded-xl">
            <div className="absolute top-0 w-[103.05px] h-[75] overflow-hidden rounded-xl">
                <img className="w-full h-full object-cover rounded-t-[6.44px]"src={postimg || sampleimg}/>
            </div>
            <div className="absolute top-[66px] w-[103px] h-[88px] rounded-xl bg-kuLightGray">
                <div className="relative">
                    <div className="absolute top-[10px] left-[10px] text-[10px]">{date}</div>
