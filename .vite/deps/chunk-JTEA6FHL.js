...
function endOfISOWeekYear(date, options) {
  const year = getISOWeekYear(date, options);
  const fourthOfJanuaryOfNextYear = constructFrom(
    (options == null ? void 0 : options.in) || date,
    0,
  );
  fourthOfJanuaryOfNextYear.setFullYear(year + 1, 0, 4);
...
function getWeekYear(date, options) {
  ...
  const firstWeekContainsDate =
    ...
    1;
  const firstWeekOfNextYear = constructFrom(
    (options == null ? void 0 : options.in) || date,
    0,
  );
  ...
  const firstWeekOfThisYear = constructFrom(
    (options == null ? void 0 : options.in) || date,
    0,
  );
...
function formatRelative2(date, baseDate, options) {
  var _a, _b, _c, _d;
  const [date_, baseDate_] = normalizeDates(
    options == null ? void 0 : options.in,
    date,
    baseDate,
  );
...
function getWeekOfMonth(date, options) {
  ...
  const weekStartsOn =
    ...
    ((_d = (_c = defaultOptions2.locale) == null ? void 0 : _c.options) == null
      ...
      : _d.weekStartsOn) ??
    0;
  const currentDayOfMonth = getDate(
...
function interval(start, end, options) {
  const [_start, _end] = normalizeDates(
    options == null ? void 0 : options.in,
    start,
    end,
  );
...
function isConstructor(constructor) {
  ...
  return (
    ...
    ((_a = constructor.prototype) == null ? void 0 : _a.constructor) ===
      constructor
  );
}
...
function parse(dateStr, formatStr, referenceDate, options) {
  ...
  const invalidDate = () =>
    constructFrom(
      (options == null ? void 0 : options.in) || referenceDate,
      NaN,
    );
  ...
  if (!formatStr)
    return dateStr
      ? invalidDate()
      : toDate(referenceDate, options == null ? void 0 : options.in);
  const subFnOptions = {
    firstWeekContainsDate,
    weekStartsOn,
    locale,
...
function parseISO(argument, options) {
  const invalidDate = () =>
    constructFrom(options == null ? void 0 : options.in, NaN);
